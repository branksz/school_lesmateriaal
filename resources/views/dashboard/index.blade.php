			...
			<div class="row row--white pb-3">
				<div class="col-12 col-lg-8 mt-4">
					...
					<div class="newestItem mt-3 p-3 border-grey">
						...
						<a href="{{ $entry['slug'] }}">Lees verder <i class="fa fa-arrow-right"></i></a>
					</div>
				</div>
				<div class="col-12 col-lg-4 mt-4">
					...
					@foreach ($entries as $entry)
						<a href="{{ $entry['slug'] }}" class="btn btn-info d-block text-white ml-0 mt-2 mb-2 pb-3 pt-3">Week {{ $entry['week'] }}</a>
					@endforeach
